...
const TaskCard: React.FC<TaskCardProps> = ({ task, key }) => {
    ...
    return (
        <div className={`grid gap-y-1 border border-[#B8B8B8] rounded-[20px] p-2 md:p-3 cursor-pointer ${showDetails ? " row-span-2":""}`} key={key} onClick={openDetailsHandler}>
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                    ...
                    <div className={`px-1 md:px-2 py-1 font-semibold border-0 bg-[#F7F7F7] rounded-[20px] text-[12px] ${task.taskStatus === "Not Accepted" ? "text-[#CC2610] bg-[#F7F7F7]" :
