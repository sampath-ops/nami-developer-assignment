                ...
                TaskList.map((index) => (
                    <div className="grid gap-y-1 border border-[#B8B8B8] rounded-[20px] p-3 md:p-4" key={index}>
                        <div className="flex justify-between items-center">
                            ...
                            <div className="grid gap-1 grid-cols-[auto,auto] items-center bg-[#D7FFE7] rounded-full px-2">
                                    <img src={greenClock} alt="clock" />
                                    <p className="text-[#00A441] text-[12px] font-semibold">20 min</p>
                            </div>
                        </div>
                        <div className="flex justify-between items-center">
                            <p className=" text-[14px] md:text-[16px] font-bold">Routine Cleaning</p>
                            <div className="px-1 py-0 border-0 md:p-1 text-[#DC5B19] bg-[#F7F7F7] rounded-[20px] text-[12px] font-semibold">Guest task</div>
                        </div>
                        ...
                        <div className="flex justify-between">
                            <p className="text-[12px] md:text-[16px] text-[#767676] font-semibold">From:Pantry</p>
                            <p className="text-[12px] md:text-[16px] text-[#767676] font-semibold">To:Reception</p>
                        </div>
